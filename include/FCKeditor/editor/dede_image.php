...
if($dopost=='upload')
{
	...
	for($i=1; $i <= $totalform; $i++)
	{
	 ...
	 if($cfg_remote_site=='Y' && $remoteuploads == 1)
	 {
	 	  ...
	 	  $imgHtml .=  "<img src=$cfg_cmsurl"\$imgsrcValue\" width=\"$imgwidthValue\" border=\"0\" height=\"$imgheightValue\" alt=\"$altname\" style=\"cursor:pointer\" /><br />\r\n";
	 } else {
			if($cfg_multi_site=='N')
			{
				$imgHtml .=  "<img src=$cfg_cmsurl"\$imgsrcValue\" width=\"$imgwidthValue\" border=\"0\" height=\"$imgheightValue\" alt=\"$altname\" style=\"cursor:pointer\" /><br />\r\n";
	...
	<tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="166" nowrap><input name="url" type="text" id="url" size="30"   value="" /></td>
